...
<svelte:head>
    ...
    <meta name="keywords" content="Audiovisuel, Expérience, Réaliser, Univers atypiques, Créer de l'émotion, Contact" />
    <meta
        name="description"
        content="Découvrir Paul & Mathias, deux réalisateurs français passionnés. Nous contacter."
    />
</svelte:head>
