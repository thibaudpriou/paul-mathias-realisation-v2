 ...
 */
 ...
 class SwipeDetect {
    ...
    */
   enable() {
     this.target.addEventListener('touchstart', this.recordTouchStartValues.bind(this), {passive: true});
     this.target.addEventListener('touchend', this.detectSwipeDirection.bind(this), {passive: true});
   }
